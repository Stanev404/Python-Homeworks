...
Входните данни приемайте като параметри от командния ред (виж слайдове 27 и 28 на презентация 3), а не четете от клавиатурата с input/raw_input
...
Напишете програма, която взима списък и прави нов, в който всеки от елементите на първия се среща точно веднъж.
Вход: FXXXXX_L2_T3.py 6 3 7 4 7 4 7 4 8 4 3 8 4 3 8 3 9 4 3
Изход: [3, 4, 6, 7, 8, 9]
